...
var DET_CASES = [
  ...
  // ───────── ZOR (10): 3 baş şüpheli + ince ayırt ediciler — oyuncu 2-3 isim arasında sıkışır, suçluyu ufak bir detay belirler ─────────
  { t:"Üç Kurban", e:"Seri Cinayet", d:"hard", st:"Üç şüpheli de güçlü; suçluyu, üç geceye dağılan ince bir ayrıntı belirler.", nS:8, nW:2, c:5,
    sum:"Bir sitede üç kişi aynı balıkçı düğümüyle boğuldu. Düğümü bilen, güdüsü olan üç isim öne çıkıyor ve üçü de eşit derecede şüpheli. Suçluyu bulmak için her birinin üç gece boyunca nerede olduğunu tek tek kovuşturmak gerekiyor.",
    sol:"Katil {S6} adlı kişi. Balıkçı düğümünü bilen üç şüpheliden ({S2}, {S5}, {S6}) tekneci komşu ikinci cinayet gecesi denizdeydi, dağcılık eğitmeni ise birinci cinayet gecesi ders veriyordu; oysa katil üç gecede de iş başındaydı, dolayısıyla ikisi de elenir. Geriye {S6} adlı kişi kalıyor: servis aracı üçüncü gece sitedeydi, üç dairede de panolar yalnızca elektrikçilerin taşıdığı bir aletle açılmıştı ve bir kurbana borcu vardı. Hemşireyi işaret eden nitril eldiven ve hırsızlık suçlaması ise yanıltıcı; hemşire düğümü bilmiyor.",
    S:[["Apartman yöneticisi","Ana anahtarı var ama düğüm bağlamayı bilmez; kurbanlarla şikâyet gerginliği vardı."],["Tekneci komşu","Balıkçı düğümünü bilir; bir kurbanla arsa kavgası vardı."],["Kurye","Binaya girer ama kişisel husumeti yok."],["Bakım hemşiresi","İki kurbana bakardı; biri onu hırsızlıkla suçlamıştı."],["Dağcılık eğitmeni","Düğüm uzmanı; bir kurbanın eski sevgilisi."],["Elektrik teknisyeni","Yelken hobisiyle düğümü bilir; tüm dairelere servis verir; bir kurbana borçluydu."],["Emekli komşu","Gürültü kavgası vardı; teknik bilgisi yok."],["Temizlikçi","Yalnızca koridorları temizler."]],
    E:[["forensic","Düğüm","Üç kurban da balıkçı düğümüyle boğulmuş; bu düğümü bilenler tekneci komşu {S2}, dağcılık eğitmeni {S5} ve yelken yapan elektrik teknisyeni {S6}.",1,0],
       ["other","Üç Gece","Cinayetler üç ayrı gece işlendi; katil üç gecede de iş başındaydı.",1,0],
       ["gps","Tekneci","Liman kaydı, {S2} adlı kişinin ikinci cinayet gecesi denizde olduğunu gösteriyor.",1,0],
       ["phone","Eğitmen","Katılımcı listesi, {S5} adlı kişinin birinci cinayet gecesi gece tırmanış dersi verdiğini gösteriyor.",1,0],
       ["gps","Servis Aracı","{S6} adlı kişinin servis aracı üçüncü cinayet gecesi sitenin önünde sinyal veriyor.",1,0],
       ["forensic","Açılmış Panolar","Üç dairede de elektrik panosu açılmış; katil içeri pano bahanesiyle girip özel bir aletle açmış.",1,0],
       ["forensic","Pano Aleti","Panoları açan alet, yalnızca elektrik teknisyenlerinin taşıdığı bir tip.",1,0],
       ["forensic","Eldiven","Bir kurbanın tırnağında nitril eldiven parçası var; hem hemşire hem teknisyen kullanır.",0,1],
       ["phone","Hırsızlık","Kurbanlardan biri bakım hemşiresini hırsızlıkla suçlamıştı.",0,1],
       ["other","Yönetici Anahtarı","Yöneticinin ana anahtarı var ama balıkçı düğümünü bağlamayı bilmiyor.",1,0],
       ["phone","Borç","{S6} adlı kişinin bir kurbana ödenmemiş borcu mesajlarda görünüyor.",1,0],
       ["witness","Tanık {W1}","{W1}, üçüncü cinayet gecesi {S6} adlı kişiyi üçüncü kattan inerken görmüş.",1,0],
       ["witness","Tanık {W2}","{W2}, emekli komşunun o gecelerde evinde olduğunu doğruluyor.",1,0]] },

  { t:"Kasadaki Hayalet", e:"Büyük Banka Soygunu", d:"hard", st:"Üç isim de profile uyuyor; ayrım, kart ve panel ayrıntılarında saklı.", nS:8, nW:2, c:4,
    sum:"Bir bankanın kasası hafta sonu boşaltıldı. Koda ve alarma hâkim üç isim öne çıkıyor ve üçü de güçlü şüpheli. Doğru kişiyi bulmak için giriş kayıtlarını ve alarmın nasıl kapatıldığını dikkatle okumak gerekiyor.",
    sol:"Soyguncu {S5} adlı kişi. Profile uyan üçten ({S1}, {S2}, {S5}) müdür cuma akşamı çıkıp bir daha dönmedi, oysa kasa cumartesi gecesi boşaltıldı; güvenlik şefinin kartı da cumartesi binaya hiç okutulmadı, yani şifresi kullanılmış olsa bile o gece içeride değildi. Alarmı fiziksel panelden kapatmak içeride olmayı gerektiriyordu ve o gece kasa katına giren, kodu bilen tek isim {S5} adlı kişiydi; haftalardır şefin şifresini omzundan izliyordu ve panel kamerası onu gösteriyor. Sistem yöneticisinin uzaktan denemesi başarısızdı.",
    S:[["Banka müdürü","Kasa kodunu ve alarmı bilir."],["Güvenlik şefi","Alarm panelinin şifresi onda."],["Sistem yöneticisi","Alarmı uzaktan kapatma yetkisi var."],["Veznedar","Kasa katına nadiren çıkar."],["Baş kasiyer","Kasa kodunu bilir, şefin yanında oturur; ağır borçlu."],["Gece temizlikçisi","İçeride temizlik yapar, kasayı açamaz."],["Kurye","Yalnızca zemin kata gelir."],["Eski şef yardımcısı","Kovulmuştu; giriş kartı iptal."]],
    E:[["other","Profil","Soygun, kasa koduna ve alarma hâkim birinin işi; profile uyan üç kişi var: müdür {S1}, güvenlik şefi {S2}, baş kasiyer {S5}.",1,0],
       ["other","Soygun Anı","Kasa cumartesi gecesi 02:00'de boşaltıldı.",1,0],
       ["gps","Müdür Çıkışı","{S1} adlı kişinin kartı cuma 19:50'de çıkış okuttu; aracı tüm gece evinde sinyal verdi, cumartesi binaya hiç dönmedi.",1,0],
       ["other","Fiziksel Panel","Alarm fiziksel panelden kapatılmış; bunu yapmak için o anda bina içinde olmak gerek.",1,0],
       ["gps","Şef Kartı","{S2} adlı kişinin kartı cumartesi binaya hiç okutulmadı; yani şifresi onun olsa da o gece içeride değildi.",1,0],
       ["gps","Kasiyer Kartı","{S5} adlı kişinin kartı cumartesi gece kasa katına giriş okuttu.",1,0],
       ["witness","Tanık {W1}","{W1}, {S5} adlı kişinin haftalardır şefin panel şifresini omzundan izlediğini fark etmiş.",1,0],
       ["camera","Panel Kamerası","Panel kamerası soygun saatinde {S5} adlı kişiyi panelin başında gösteriyor.",1,0],
       ["phone","Uzaktan Deneme","Sistem yöneticisinin uzaktan alarm kapatma denemesi başarısız olmuş ve kendisi görüntülü toplantıdaydı.",0,1],
       ["other","Kasa Kodu","Kasa kodunu yalnızca müdür ve baş kasiyer biliyordu.",1,0],
       ["phone","Borç","{S5} adlı kişinin ağır borçları mesajlarda görünüyor.",1,0],
       ["other","Temizlikçi","Temizlikçi kasayı açacak kodu ve yetkiyi bilmiyor.",1,0],
       ["forensic","Maske","Kasada izsiz bir maske bulundu.",0,1]] },

  { t:"Sahnedeki Suikast", e:"Suikast", d:"hard", st:"Açıya uyan üç konum var; ikisi ufak ayrıntılarla elenir.", nS:8, nW:2, c:4,
    sum:"Kalabalık bir etkinlikte konuşmacı vuruldu. Kurşunun açısı yüksek bir noktadan ve bu açıya üç konum birden uyuyor. Üçünü de aynı anda değerlendirip kimin elendiğini görmek gerekiyor.",
    sol:"Suikastçı {S5} adlı kişi. Açının uyduğu üç yerden ({S2}, {S5}, {S6}) kameraman atış anında iki eliyle kamerada, canlı yayında görünüyor; üst balkonun atış hattı ise o gün asılan afişle kapalıydı. Geriye ses kabini kalıyor: telsizde atışı kapsayan 90 saniyelik boşluk var, silahı içeri sokan aranmamış kasaları {S5} adlı kişi taşıyordu ve kabin arkasındaki havalandırmada kovan bulundu. Aktivistin barutu ve gazetecinin yazıları dikkat çekse de zeminden bu açıyla atış imkânsızdı.",
    S:[["Etkinlik organizatörü","Sahne önünde, herkesin gözü önündeydi."],["Kameraman","Yüksek platformda; açı uyuyor."],["Güvenlik amiri","Ana kapıda; kurbanla eski tartışması vardı."],["Konuk gazeteci","Ön sırada; kurban hakkında sert yazılar yazmıştı."],["Ses teknisyeni","Ses kabininde; açı uyuyor; ekipman kasalarını taşır."],["Işıkçı","Üst balkonda; açı uyuyor."],["Husumetli aktivist","Sahte kartla içeride; elinde barut, kurbanla husumetli."],["Sahne görevlisi","Kulis kapısında."]],
    E:[["forensic","Atış Açısı","Kurşunun açısı yüksek bir noktadan; bu açıya uyan üç yer ve kişi var: kamera platformu (kameraman {S2}), ses kabini (ses teknisyeni {S5}), üst balkon (ışıkçı {S6}).",1,0],
       ["camera","Canlı Yayın","Atış anında {S2} adlı kişi canlı yayında, iki eli de kameranın üstünde görünüyor.",1,0],
       ["other","Balkon Afişi","O gün üst balkonun önüne büyük bir afiş asılmış; balkondan sahneye atış hattı afişle kapalıydı.",1,0],
       ["other","Talkback Boşluğu","Ses kabini telsizinde atışı kapsayan 90 saniyelik bir sessizlik var; kabinde kimse görünmüyor.",1,0],
       ["forensic","Kasalar","Silahı aranmadan içeri sokabilecek ekipman kasalarını {S5} adlı kişi taşıyordu.",1,0],
       ["forensic","Kovan","{S5} adlı kişinin kabini arkasındaki havalandırmada kovan bulundu.",1,0],
       ["forensic","Aktivist Barutu","Aktivistin barutu, güvenliğin kullandığı ses bombasından; kurşunla uyuşmuyor.",0,1],
       ["other","Atış Yüksekliği","Atış yüksek bir noktadan yapılmış; zeminden ya da ön sıradan bu açı imkânsız.",1,0],
       ["phone","Gazeteci","{S4} adlı kişinin kurban hakkında sert yazıları vardı.",0,1],
       ["phone","Ödeme","{S5} adlı kişinin hesabına etkinlik öncesi kaynağı belirsiz büyük ödeme girmiş.",1,0],
       ["gps","Güvenlik Amiri","Güvenlik amiri atış anında ana girişte telsizdeydi, kaydı sürekli.",1,0],
       ["witness","Tanık {W1}","{W1}, atış anında ses kabininin kapalı ama boş göründüğünü fark etmiş.",1,0],
       ["witness","Tanık {W2}","{W2}, kameramanın iki elinin de yayın boyunca kamerada olduğunu doğruluyor.",1,0]] },

  { t:"Gümrüğün Gölgesi", e:"Organize Kaçakçılık", d:"hard", st:"Üç isim de işin içinde sanılıyor; ikisinin delili belgeyle masum çıkar.", nS:8, nW:2, c:1,
    sum:"Bir gümrükten aylardır yasak mal geçiyor. Onay, kayıt ve tarama üzerinden üç isim öne çıkıyor. Ama kaçakçılığın nasıl yapıldığına ve her birinin delilinin ne anlama geldiğine bakmak gerekiyor.",
    sol:"Asıl suçlu {S2} adlı kişi. Öne çıkan üçten ({S1}, {S4}, {S2}) şefin onayları belgeli yasal kargolara aitti ve paravan şirket adaş çıktı; vardiya amirinin nakdi belgeli mesaiydi ve bazı şüpheli geçişlerde vardiyada bile değildi. Yasak konteynerlerin temiz görünmesi cihaza sahte görüntü eklemekle olur; bunu yapabilecek bakım teknisyeni izindeydi, konsolda oturan tek isim {S2} adlı kişiydi, belleğinde sahte görüntüler bulundu ve bir yakınına her geçiş sonrası ödeme girdi.",
    S:[["Gümrük şefi","Onay yetkisi geniş; adına paravan şirket iddiası var."],["Tarama operatörü","Tarama cihazını o çalıştırır."],["Bariyer bekçisi","Geçişi açar, sisteme erişemez."],["Vardiya amiri","Vardiyaları düzenler; hesabına nakit girdi."],["Evrak memuru","Taramaya erişemez."],["Bakım teknisyeni","Cihaz bakımı yapar; aylardır izinde."],["Forklift operatörü","Ekrana erişemez."],["Stajyer","Yetkisi yok."]],
    E:[["forensic","Temiz Tarama","Yasak konteynerler taramada tertemiz; bu ancak cihaza önceden kaydedilmiş temiz görüntü eklenerek olur.",1,0],
       ["other","Profil","Bu işe karışabilecek üç isim öne çıkıyor: onay veren şef {S1}, kayıt tutan vardiya amiri {S4}, taramayı yapan operatör {S2}.",1,0],
       ["phone","Şef Onayları","{S1} adlı kişinin imzaladığı onayların hepsi belgeli, yasal kargolara ait çıktı.",1,0],
       ["phone","Paravan","{S1} adlı kişiye atfedilen şirketin sahibi, aynı adı taşıyan başka biri çıktı.",1,0],
       ["gps","Amir Vardiyası","{S4} adlı kişi şüpheli geçişlerin bir kısmında vardiyada bile değildi.",1,0],
       ["phone","Amir Nakdi","{S4} adlı kişinin nakdi, belgeli fazla mesai ödemesi çıktı.",1,0],
       ["other","Görüntü Ekleme","Sahte tarama görüntüsünü ekleyebilecek konumda olan, cihazı çalıştıran kişidir; bakımcı ise izindeydi.",1,0],
       ["phone","Teknisyen İzni","Bakım teknisyeni şüpheli geçişlerin tamamında belgeli izindeydi.",1,0],
       ["gps","Konsol","Şüpheli geçişlerde konsolda oturum açan tek kişi {S2} adlı kişiydi.",1,0],
       ["other","Bellek","Cihaz belleğinde, gerçek konteynerle örtüşmeyen sahte temiz tarama görüntüleri bulundu.",1,0],
       ["phone","Operatör Ödemesi","{S2} adlı kişinin bir yakınının hesabına her geçişin ertesi günü ödeme girmiş.",1,0],
       ["witness","Tanık {W1}","{W1}, {S2} adlı kişinin şüpheli kamyonlarda ekranı eliyle kapattığını görmüş.",1,0],
       ["witness","Tanık {W2}","{W2}, bakım teknisyeninin aylardır işe gelmediğini doğruluyor.",1,0],
       ["forensic","Sahte Mühür","Bir konteynerde sahte mühür var ama çok kişi bu mühre erişebiliyor.",0,1]] },

  { t:"Ormandaki İz", e:"Kayıp Kişi", d:"hard", st:"Yolu bilen üç isim var; ikisi kamera ve fotoğrafla elenir.", nS:8, nW:2, c:5,
    sum:"Grup yürüyüşünden biri dönmedi. Kurbanı o bölgeye götürebilecek, yolu bilen üç isim öne çıkıyor. Suçluyu bulmak için son sinyalin nereden geldiğini ve her birinin nerede göründüğünü birleştirmek gerekiyor.",
    sol:"Sorumlu {S6} adlı kişi. Yolu bilen üçten ({S1}, {S5}, {S6}) iş ortağı olay boyunca fotokapanda ana yolda, deneyimli dost ise grup fotoğraflarının hepsinde görünüyor. Kurbanın son sinyali yalnızca personel servis yolundan erişilen bir noktadan geldi ve o yolun kapısı yalnızca {S6} adlı kişinin anahtarıyla açılıyor; telsiz kaydındaki 40 dakikalık boşluk ve botundaki dere çamuru da bunu doğruluyor. İş ortağının borç ve sigorta gerginliği ise yanıltıcı.",
    S:[["İş ortağı","Kurbanla borç yüzünden tartışıyordu; sigortadan kazancı var."],["Tur rehberi","Grubu yönetti; rotayı o belirledi."],["Kurbanın eşi","Kamp alanında kaldı."],["Acemi kampçı","Yolu bilmez, gruba yapışıktı."],["Deneyimli patika dostu","Bölgeyi iyi bilir; kurbanla aynı gruptaydı."],["Park görevlisi","Tüm yolları ve servis yolunu bilir; kulübede telsiz başındaydı."],["Doğa fotoğrafçısı","Ana patikada sabit çekim yapıyordu."],["Sırt çantacı genç","Grubun önündeydi."]],
    E:[["gps","Son Sinyal","Kurbanın son telefon sinyali, gruba ait patikadan değil, yalnızca personel servis yolundan erişilen bir noktadan geldi.",1,0],
       ["other","Profil","Kurbanı o bölgeye götürebilecek, yolu bilen üç isim var: iş ortağı {S1}, deneyimli dost {S5}, park görevlisi {S6}.",1,0],
       ["camera","Fotokapan","Ana patikadaki fotokapan, {S1} adlı kişiyi olay boyunca ana yolda gösteriyor.",1,0],
       ["camera","Grup Fotoğrafları","{S5} adlı kişi, kaybolma saatinde çekilen grup fotoğraflarının hepsinde görünüyor.",1,0],
       ["other","Servis Yolu Anahtarı","O servis yoluna halk giremez; kapısı yalnızca {S6} adlı kişinin anahtarıyla açılır.",1,0],
       ["phone","Telsiz Boşluğu","{S6} adlı kişinin telsiz kaydında, kaybolma saatlerini kapsayan 40 dakikalık sessizlik var.",1,0],
       ["forensic","Çamur","{S6} adlı kişinin botundaki çamur, servis yolundaki dere kenarına ait.",1,0],
       ["phone","Borç ve Sigorta","{S1} adlı kişinin kurbanla borcu ve sigorta kazancı olduğu biliniyor.",0,1],
       ["witness","Tanık {W1}","{W1}, kurbanla iş ortağının çıkıştan önce tartıştığını gördü.",0,1],
       ["gps","Rehber","Tur rehberi tüm grupla ana patikada baz veriyor.",1,0],
       ["camera","Kamp","Kurbanın eşi kamp kamerasında sürekli görünüyor.",1,0],
       ["witness","Tanık {W2}","{W2}, görevlinin o gün kulübeden uzun süre ayrıldığını söylüyor.",1,0],
       ["forensic","Kesik İp","Servis yolunda kesik bir ip parçası bulundu.",1,0]] },

  { t:"Sızan Tasarım", e:"Kurumsal Casusluk", d:"hard", st:"Kaynağa ulaşan üç isim var; ikisi ufak ayrıntılarla elenir.", nS:8, nW:2, c:1,
    sum:"Gizli bir tasarım rakibe sızdı. Kaynağa ulaşabilen üç isim öne çıkıyor. Sızıntının türüne ve her birinin izine bakınca, en sağlam görünen mazeret asıl suçluyu ele veriyor.",
    sol:"Sorumlu {S2} adlı kişi. Kaynağa ulaşabilen üçten ({S1}, {S2}, {S6}) kıdemli tasarımcı dosyaya yalnızca ofiste baktı ve rakip yazışması iş görüşmesiydi; sızıntı bir ekran görüntüsü olduğu için baskı sorumlusunun biriminden de geçmedi. Görüntünün gizli konum etiketi bir fuar otelini gösteriyor ve o hafta orada kalan tek çalışan {S2} adlı kişiydi; şifreli rakip yazışması ve fuar haftası giren ödeme de bunu doğruluyor.",
    S:[["Kıdemli tasarımcı","Dosyaya erişimi vardı, terfi alamadı, rakiple yazışması çıktı."],["Proje müdürü","Tüm kaynak dosyalara erişir; o hafta bir sektör fuarındaydı."],["Pazarlama uzmanı","Yalnızca hazır görselleri görür."],["Stajyer tasarımcı","Sadece izleme yetkisi."],["Hukuk danışmanı","Tasarım dosyasına erişimi yok."],["Baskı sorumlusu","Çıktılar onun biriminden geçer."],["Satış temsilcisi","İç sisteme giremez."],["Ofis asistanı","Dosya yetkisi yok."]],
    E:[["forensic","Sızıntı Türü","Rakibe giden tasarım bir ekran görüntüsü; dosya değil, ekrandan çekilmiş bir kare.",1,0],
       ["other","Profil","Yüksek çözünürlüklü kaynağa ulaşabilen üç isim var: kıdemli tasarımcı {S1}, proje müdürü {S2}, baskı sorumlusu {S6}.",1,0],
       ["gps","Kıdemli Erişim","{S1} adlı kişi dosyaya yalnızca ofiste baktı; dışarı hiçbir aktarım çıkmadı.",1,0],
       ["phone","Kıdemli Yazışma","{S1} adlı kişinin rakiple yazışması bir iş görüşmesiydi; ekinde dosya ya da görsel yok.",1,0],
       ["other","Baskı Değil","Sızıntı bir çıktı değil ekran görüntüsü olduğundan baskı biriminden hiç geçmedi.",1,0],
       ["gps","Konum Etiketi","Ekran görüntüsünün gizli konum etiketi ofisi değil, bir otel fuar alanını gösteriyor.",1,0],
       ["other","Fuar","O hafta o fuarda kalan tek çalışan {S2} adlı kişiydi.",1,0],
       ["phone","Müdür Yazışması","{S2} adlı kişinin rakiple şifreli yazıştığı, fuar günlerine denk gelen mesajlardan anlaşılıyor.",1,0],
       ["phone","Ödeme","{S2} adlı kişinin hesabına fuar haftası rakip bağlantılı bir ödeme girmiş.",1,0],
       ["witness","Tanık {W1}","{W1}, {S2} adlı kişiyi fuar otelinde dizüstüyle tasarım ekranını açıkken görmüş.",1,0],
       ["phone","Terfi","{S1} adlı kişinin terfi alamadığı için kırgın olduğu biliniyor.",0,1],
       ["other","Pazarlama","Pazarlama uzmanı yalnızca hazır görselleri görür, kaynağa erişemez.",1,0],
       ["forensic","USB","Ofiste boş bir USB bulundu, sahibi belirsiz.",0,1]] },

  { t:"Fidye Notu", e:"Kaçırma ve Fidye", d:"hard", st:"Lakabı bilen üç isim var; ikisinin hikâyesi tutar.", nS:8, nW:2, c:6,
    sum:"Bir çocuk kaçırıldı. Nottaki ev içi lakap, işin içeriden olduğunu söylüyor. Lakabı bilen, çocuğa yaklaşabilen üç isim öne çıkıyor ve doğru kişiyi bulmak için her birinin o günkü hikâyesini denetlemek gerekiyor.",
    sol:"Sorumlu {S7} adlı kişi. Lakabı bilen üçten ({S3}, {S4}, {S7}) şoförün rota sapması belgeli bir araç servisine çıktı; eski muhasebecinin tehditleri aylar öncesindendi ve kaçırma saatinde şehrin öbür ucundaydı. {S7} adlı kişinin ise izinli olduğu iddiası doğrulanmıyor, telefonu çocuğun götürüldüğü deponun yakınında sinyal verdi ve fidye hattı onun yakınının adına kayıtlı; çocuğun direnmeden gitmesi de güvendiği birini işaret ediyor.",
    S:[["İş ortağı","Ortaklık kavgası vardı; kaçırma günü yurt dışında."],["Çocuğun öğretmeni","Çocuğu okuldan tanır."],["Aile şoförü","Çocuğun rutinini bilir; o gün rota sapması var."],["Eski muhasebeci","Aileye kin besler, tehdit mesajı atmıştı."],["Bahçıvan","Evin dışında çalışır."],["Komşu","Aileyle yüzeysel tanışıklık."],["Dadı","Çocuğun lakabını ve rutinini bilir; o gün izinli olduğunu söyledi."],["Aile avukatı","Mali işleri bilir."]],
    E:[["other","Not Detayı","Fidye notunda çocuğun yalnızca ev halkının bildiği özel lakabı kullanılmış; iş içeriden.",1,0],
       ["other","Profil","Çocuğun lakabını ve rutinini bilen, ona yaklaşabilen üç isim var: şoför {S3}, eski muhasebeci {S4}, dadı {S7}.",1,0],
       ["gps","Şoför Rotası","{S3} adlı kişinin aracı o gün rotadan saptı ama gittiği yer belgeli bir araç servisiydi.",1,0],
       ["phone","Tehdit Tarihi","{S4} adlı kişinin tehdit mesajları aylar öncesine ait.",1,0],
       ["gps","Muhasebeci Konumu","{S4} adlı kişi kaçırma saatinde şehrin öbür ucunda baz veriyor.",1,0],
       ["gps","Dadı Konumu","{S7} adlı kişi o gün izinli olduğunu söylese de telefonu deponun yakınında sinyal verdi.",1,0],
       ["other","İzin İddiası","{S7} adlı kişinin izinli olduğu iddiası hiçbir kayıtla doğrulanmıyor.",1,0],
       ["phone","Fidye Hattı","Fidye hattı {S7} adlı kişinin bir yakınının adına kayıtlı.",1,0],
       ["witness","Tanık {W1}","{W1}, çocuğun tanıdığı birinin elinden tutup hiç direnmeden gittiğini görmüş.",1,0],
       ["phone","Borç","{S7} adlı kişinin ödenmemiş borçları olduğu anlaşıldı.",1,0],
       ["phone","İş Ortağı","İş ortağı kaçırma günü yurt dışındaydı, kaydı var.",1,0],
       ["witness","Tanık {W2}","{W2}, eski muhasebecinin son aylarda şehirde olmadığını söylüyor.",0,1],
       ["forensic","Kağıt","Fidye notu sıradan kağıda yazılmış.",0,1]] },

  { t:"Müzedeki Boş Çerçeve", e:"Sanat Eseri Hırsızlığı", d:"hard", st:"Üç isim öne çıkıyor; boya ve katalog ayrıntısı suçluyu seçer.", nS:8, nW:2, c:6,
    sum:"Bir müzeden tablo çalındı sanılıyor. Gece komutu, tabloyu elinde tutanlar derken üç isim öne çıkıyor. Ama çerçevedeki sahtenin boyası, olayın ne zaman olduğunu ve kimin yaptığını değiştiriyor.",
    sol:"Hırsız {S7} adlı kişi. Sahtenin boyası, değişimin o gece değil haftalar önce olduğunu gösteriyor; öne çıkan üçten ({S1}, {S3}, {S7}) teknisyenin terminalinden girilen komut önceden zamanlanmış bir bakımdı, restoratörün seansları kayıtlıydı ve iade ettiğinde eser gerçek diye onaylanmıştı. Sahtenin kataloğa gerçek gibi geçmesi için katalog kaydının değişmesi gerekiyordu ve kataloğa yalnızca {S7} adlı kişi yazabiliyor; pigment erişimi ve gizli alıcı yazışması da ona ait.",
    S:[["Güvenlik teknisyeni","Gece komutu onun terminalinden girildi."],["Müze müdürü","O gece galadaydı."],["Restoratör","Tabloyu temizlik için elinde tutmuştu."],["Bekçi","Turla dolaşır."],["Rehber","Gündüz çalışır."],["Temizlikçi","Teknik sisteme erişemez."],["Küratör","Katalogları o yazar; envanter için eserlerle haftalarca yalnız kalır."],["Sigorta eksperi","Rapor için gelmişti."]],
    E:[["forensic","Sahte Boya","Çerçevedeki sahtenin boyası tam kürlenmemiş; değişim o gece değil, haftalar önce yapılmış.",1,0],
       ["other","Profil","Öne çıkan üç isim: gece komutu terminalinden girilen güvenlik teknisyeni {S1}, tabloyu elinde tutan restoratör {S3}, envanterde tutan küratör {S7}.",1,0],
       ["other","Zamanlanmış Görev","Gece komutu, ortak bakım hesabıyla önceden zamanlanmış bir bakımdı; {S1} adlı kişi o saatte evindeydi.",1,0],
       ["other","Restoratör Kaydı","{S3} adlı kişinin her seansı kamera ve imzayla kayıtlı; iade ettiğinde eser gerçek diye onaylanmıştı.",1,0],
       ["other","Katalog","Sahtenin gerçek gibi kayda geçmesi için katalog kaydının değişmesi gerekiyordu; kataloğa yalnızca {S7} adlı kişi yazabilir.",1,0],
       ["forensic","Pigment","Sahtenin modern pigmentlerine erişim, envanter deposunu kullanan {S7} adlı kişide vardı.",1,0],
       ["phone","Gizli Alıcı","{S7} adlı kişinin bir koleksiyoncuyla gizli satış yazışması bulundu.",1,0],
       ["camera","Gala","Müze müdürü o gece galada kameraya yakalanıyor.",1,0],
       ["witness","Tanık {W1}","{W1}, son haftalarda eseri en çok {S7} adlı kişinin, çoğu zaman tek başına incelediğini söylüyor.",1,0],
       ["phone","Gece Komutu","Gece kamerayı döngüye alan komut, ilk bakışta teknisyenin terminalinden girilmiş görünüyor.",0,1],
       ["witness","Tanık {W2}","{W2}, gece teknik odanın boş olduğunu doğruluyor.",1,0],
       ["forensic","Eldiven","Çerçevede eldiven izi var ama tüm personel aynı eldiveni kullanır.",0,1]] },

  { t:"Hayalet Hesaplar", e:"Siber Dolandırıcılık Ağı", d:"hard", st:"Üç isim öne çıkıyor; izin gösterdiği kişi tuzağa düşürülmüş.", nS:8, nW:2, c:2,
    sum:"Bir şirketin altyapısıyla sahte hesaplar açıldı. Oturum bir geliştiriciye çıkıyor, yetki bir yöneticide, anahtarlar bir başkasında. Üç isim öne çıkıyor ve doğru kişiyi bulmak için izlerin nasıl bırakıldığını anlamak gerekiyor.",
    sol:"Sorumlu {S3} adlı kişi. Öne çıkan üçten ({S7}, {S2}, {S3}) kıdemli geliştirici olay sırasında uçaktaydı, yani adresinden gelen oturum sahteydi; veritabanı yöneticisi de o hafta izinliydi ve binaya hiç girmedi. Bir oturumun başkasının adresinden geliyormuş gibi görünmesi ancak iç ağ yönlendirmesini değiştirmekle olur ve bunu yapabilen {S3} adlı kişidir; hesaplar onun servis anahtarıyla açıldı, kayıtlarda sahte yönlendirme komutu bulundu ve olaydan sonra hesabına kripto ödemesi girdi.",
    S:[["Takım lideri","Olay haftası izindeydi."],["Veritabanı yöneticisi","Hesap açma yetkisi var; o hafta izinde."],["Ağ uzmanı","Ağ yönlendirmesini ve servis anahtarlarını o yönetir."],["Destek görevlisi","Yalnızca şifre sıfırlar."],["Tester","Test ortamına erişir."],["Sistem mimarı","Olay saatinde konferansta."],["Kıdemli geliştirici","Sahte hesap oturumu onun ev adresine çıkıyor."],["Stajyer","Yalnızca okuma yetkisi."]],
    E:[["other","Profil","Öne çıkan üç isim: oturum kıdemli geliştiricinin adresine çıkıyor ({S7}); hesap açma yetkisi veritabanı yöneticisinde ({S2}); ağ ve anahtarlar ağ uzmanında ({S3}).",1,0],
       ["gps","Uçuş","{S7} adlı kişi olay sırasında uluslararası bir uçaktaydı; biniş kartı ve uçak wifi kaydı var.",1,0],
       ["other","IP Yönlendirme","Bir oturumun başkasının adresinden geliyormuş gibi görünmesi, ancak iç ağ yönlendirmesinin değiştirilmesiyle olur.",1,0],
       ["phone","DB İzni","{S2} adlı kişi o hafta izinliydi ve binaya hiç giriş yapmadı.",1,0],
       ["other","Yönlendirme Yetkisi","İç ağ yönlendirmesini değiştirebilen kişi {S3} adlı kişidir.",1,0],
       ["other","Servis Anahtarı","Sahte hesaplar bir parolayla değil, {S3} adlı kişide duran bir servis anahtarıyla açılmış.",1,0],
       ["other","Yönlendirme İzi","Ağ kayıtlarında, olay saatinde geliştiricinin adresine sahte yönlendirme yapan bir komut bulundu.",1,0],
       ["phone","Ağ Ödemesi","{S3} adlı kişinin hesabına olaydan sonra büyük kripto ödemesi girmiş.",1,0],
       ["phone","Kripto Tuzağı","Kıdemli geliştiricinin cüzdanı bağlantılı görünüyor ama paraya o uçaktayken aktarım yapılmış.",0,1],
       ["other","Mimar","Sistem mimarı olay saatinde konferansta, kamerada.",1,0],
       ["witness","Tanık {W1}","{W1}, gece ofiste yalnız {S3} adlı kişinin kaldığını söylüyor.",1,0],
       ["phone","Çalıntı Kimlik","Kıdemli geliştiricinin VPN bilgileri masasındaki bir nottan alınmış olabilir.",0,1],
       ["forensic","Ortak Dizüstü","Ortak dizüstüde izler var ama herkes kullanır.",0,1]] },

  { t:"Köprü Altındaki İnfaz", e:"Mafya İnfazı", d:"hard", st:"Üç isim öne çıkıyor; yakın mesafe ve sahte tanıklar suçluyu seçer.", nS:8, nW:2, c:2,
    sum:"Bir örgüt adamı köprü altında infaz edildi. Balistik, güdü ve güven üzerinden üç isim öne çıkıyor. Ama atışın yakınlığı ve her delilin ne anlama geldiği doğru kişiyi gösteriyor.",
    sol:"Tetikçi {S3} adlı kişi. Öne çıkan üçten ({S4}, {S1}, {S3}) tetikçiye bağlanan silah aylar önce ondan çalınmıştı (yani balistik eşleşmesi onu bağlamaz) ve olay yerine sahte mesajla çağrılmıştı; muhasebecinin kumarhane ifadesi kesintisiz kamerayla doğrulandı. Kurban çok yakın mesafeden vurulmuş, yani katili güvendiği biriydi; patronun aracının GPSine göre {S3} adlı kişi olay anında 12 dakika konvoydan ayrılmış, onu doğrulayan tanıklar kendi astları ve infazdan sonra hesabına kayıt dışı ödeme girmiş.",
    S:[["Örgüt muhasebecisi","Para işlerini bilir; zimmet güdüsü var."],["Şoför","Patronun aracını o kullanır."],["Koruma","Kurbanın güvendiği biriydi; yakın erişim."],["Husumetli tetikçi","Kurbanla kan davası var; balistik ona bağlı silaha çıkıyor."],["Bar işletmecisi","Barı açıktı."],["Haberci","Mesaj taşır."],["Eski ortak","O gece hastanedeydi."],["Tefeci","Başka semtte tanıkla."]],
    E:[["forensic","Atış Mesafesi","Kurban çok yakın mesafeden vurulmuş; katili yanına yaklaştıracak kadar güvendiği biriydi.",1,0],
       ["other","Profil","Öne çıkan üç isim: balistiği üstünde tetikçi {S4}; zimmet güdüsündeki muhasebeci {S1}; kurbanın güvendiği koruma {S3}.",1,0],
       ["forensic","Çalıntı Silah","Balistik {S4} adlı kişiye bağlı silaha çıkıyor ama o silah aylar önce ondan çalınmış olarak kayıtlı.",1,0],
       ["gps","Tetikçi Çağrısı","{S4} adlı kişi olay yerine sahte bir buluşma mesajıyla çağrılmış.",1,0],
       ["camera","Kumarhane","{S1} adlı kişinin kumarhanedeydim ifadesi kesintisiz kamera kaydıyla doğrulandı.",1,0],
       ["gps","Patron Aracı","Patronun aracının GPSi, {S3} adlı kişinin olay saatinde 12 dakika konvoydan ayrıldığını gösteriyor.",1,0],
       ["witness","Koruma Tanıkları","{S3} adlı kişiyi doğrulayan iki tanık kendi emrindeki alt görevliler; ifadeleri birbirinin kopyası.",1,0],
       ["phone","Koruma Ödemesi","İnfazdan sonra {S3} adlı kişinin hesabına kayıt dışı büyük ödeme girmiş.",1,0],
       ["forensic","Poligon","Tetikçinin elindeki barut o gün gittiği atış poligonundan.",0,1],
       ["gps","Şoför","Şoför olay saatinde patronu başka bir adrese bırakırken araç kaydında.",1,0],
       ["witness","Tanık {W1}","{W1}, infaz anında {S3} adlı kişinin patronun yanında olmadığını fark etmiş.",1,0],
       ["phone","Hastane","Eski ortak o gece hastanedeydi, kaydı var.",1,0],
       ["forensic","İzmarit","Olay yerinde izmarit var ama DNA karışık.",0,1]] }
];
...
async function seedDetectiveChars() {
  ...
  if (ver === 'chars33h') return;
  var r = await _runDetectiveSeed();
  if (r.ok) { await setConfig('detective_seed_v', 'chars33h'); console.log('Dedektif: ' + r.count + ' vaka seed edildi (havuz: ' + r.poolSize + ' karakter).'); }
...
async function regenerateDetectiveCases() {
  var r = await _runDetectiveSeed();
  if (r.ok) await setConfig('detective_seed_v', 'chars33h');
  return r;
}

...
var DET_CASES = [
  ...
  // ───────── ZOR (10): 8 şüpheli, 12 kanıt — gerçekten zor, güçlü yanıltıcılar ─────────
  { t:"Üç Kurban", e:"Seri Cinayet", d:"hard", st:"Aynı yöntemle üç cinayet; ilk akla gelen şüpheli yanlış olabilir.", nS:8, nW:2, c:1,
    sum:"Bir mahallede üç kişi haftalar arasında aynı yöntemle boğuldu; her olay yerinde aynı özel düğüm var. Üçüyle de kavgalı, mazeretsiz biri hemen şüpheli görülüyor. Ama düğümün cinsi bu kolay cevabı sarsıyor.",
    sol:"Katil {S2} adlı kişi. Üç kurban da geçmişte ona şikâyette bulunmuş eski hastalarıydı; olay yerlerindeki düğüm ancak cerrahi eğitimi olan birinin atabileceği bir düğüm ve eldiven izindeki pudra cerrahi eldivene özgü. Nöbetteydim dediği üç gecenin kaydını da kendi imzalamış, fakat otopark kamerası arabasının her cinayet saatinde hastaneden çıktığını gösteriyor. Asıl şüphelenilen {S6} adlı kişi üç kurbanla kavgalıydı ve evinde ip bulundu; ama o ip her nalburda satılan sıradan bir ip ve {S6} adlı kişi o düğümü atmayı bilmiyor.",
    S:[["Komşu emlakçı","İlk cinayet gecesi başka şehirde, otel kaydı var."],["Mahalle doktoru","Üç kurban da ona şikâyet etmiş eski hastaları; nöbet kayıtlarını kendi imzalıyor."],["Market sahibi","İkinci cinayet saatinde dükkanı kamerada açıktı."],["Kuryeci","Cinayet saatlerinde uzak semtlerde teslimattaydı."],["Eski mahalle bekçisi","Düğüm bilir ama üçüncü gece hastanede yatıyordu."],["İşsiz tamirci","Üç kurbanla da husumeti var, hiçbir gece mazereti yok, evinde ip bulundu."],["Öğretmen","Cinayet gecelerinde dijital sınav okuyordu."],["Apartman yöneticisi","Kurbanlardan birini tanımıyordu bile."]],
    E:[["forensic","Düğüm","Üç olay yerindeki düğüm cerrahi bir düğüm; bunu ancak tıp eğitimi olan biri atabilir.",1,0],
       ["camera","Otopark","Hastane otopark kamerası, {S2} adlı kişinin arabasının üç cinayet saatinde de hastaneden ayrıldığını gösteriyor.",1,0],
       ["forensic","Eldiven Pudrası","Olay yerlerindeki eldiven izinde cerrahi eldivene özgü pudra var; sıradan iş eldiveninde bulunmaz.",1,0],
       ["phone","Şikâyetler","Üç kurban da yıllar içinde aynı kişiye sağlık şikâyeti vermiş; ortak nokta {S2} adlı kişi.",1,0],
       ["other","Nöbet İmzası","{S2} adlı kişinin nöbetteydim dediği üç gecenin kaydı kendi el yazısıyla; amir onayı yok.",1,0],
       ["forensic","Tamircinin İpi","{S6} adlı kişinin evinde ip bulundu; ama bu her nalburda satılan sıradan tip ve olay yerindeki düğümle aynı değil.",0,1],
       ["phone","Husumet","{S6} adlı kişinin üç kurbanla da açıkça kavga ettiği biliniyor.",0,1],
       ["witness","Tanık {W1}","{W1}, gecelerde iri yarı bir adam gördüğünü söylüyor; tarif {S6} adlı kişiye de uyuyor.",0,1],
       ["phone","Otel","{S1} adlı kişi ilk cinayet gecesi başka şehirde otelde kayıtlı.",1,0],
       ["camera","Dükkan","{S3} adlı kişi ikinci cinayet saatinde kendi dükkanında kamerada.",1,0],
       ["gps","Rota","{S4} adlı kişi cinayet saatlerinde uzak semtlerde teslimat yapıyor.",1,0],
       ["witness","Tanık {W2}","{W2}, eski bekçinin üçüncü gece hastanede yattığını doğruluyor.",1,0]] },

  { t:"Kasadaki Hayalet", e:"Büyük Banka Soygunu", d:"hard", st:"Kasa profesyonelce boşaltıldı; suç başkasına yıkılmış olabilir.", nS:8, nW:2, c:1,
    sum:"Bir bankanın kasa dairesi hafta sonu boşaltıldı. Tüm deliller sistem yöneticisini gösteriyor: kartı okutulmuş, komut bilgisayarından girilmiş, hesabına nakit girmiş. Fakat o sırada başka bir yerde olduğu ortaya çıkıyor.",
    sol:"Soyguncu {S2} adlı kişi. Soygun saatinde {S3} adlı kişi ailesiyle kesintisiz görüntülü görüşmedeydi, yani kasaya o giremezdi; {S3} adlı kişinin ofis kapısı ise soygundan hemen önce {S2} adlı kişinin ustabaşı kartıyla açılmış ve komut o açık terminalden girilmiş. Alarmı fiziksel panelden kapatabilen tek kişi {S2} adlı kişi; hastaneye yattığını söylese de eczane kamerası onu o gece bankanın yakınında gösteriyor ve büyük kumar borcu var.",
    S:[["Banka müdürü","Kasa şifresini bilir ama hafta sonu yurt dışında, pasaport kaydı kesin."],["Güvenlik şefi","Alarmı fiziksel panelden kapatabilen tek kişi; hafta sonu hastaneye yattığını söylüyor."],["Sistem yöneticisi","Kartı kasada okutulmuş, komut bilgisayarından girilmiş, hesabına nakit girmiş."],["Veznedar","Hafta sonu kasa erişim yetkisi kapalıydı."],["Temizlik görevlisi","Kasa katına çıkamaz."],["Baş kasiyer","Çok borçlu ama hafta sonu memleketindeki düğünde, onlarca tanık."],["Kurye","Yalnızca zemin kata gelir."],["Eski güvenlik görevlisi","Kovulmuştu, kin güdüyordu; ama o hafta sonu gözaltındaydı, kaydı var."]],
    E:[["gps","Kart","Hafta sonu kasaya {S3} adlı kişinin kartı okutulmuş.",0,1],
       ["phone","Komut","Güvenlik yazılımını kapatan komut {S3} adlı kişinin bilgisayarından girilmiş.",0,1],
       ["phone","Nakit","{S3} adlı kişinin hesabına soygundan sonra nakit girmiş.",0,1],
       ["phone","Görüntülü Görüşme","Soygun saatinde {S3} adlı kişi ailesiyle kesintisiz görüntülü görüşmede; konumu evinde doğrulanıyor.",1,0],
       ["other","Kapı Logu","{S3} adlı kişinin ofis kapısı, soygundan hemen önce {S2} adlı kişinin ustabaşı kartıyla açılmış.",1,0],
       ["forensic","Alarm Paneli","Alarmı içeriden kapatmak fiziksel panele erişim ister; bu erişim yalnızca {S2} adlı kişide var.",1,0],
       ["camera","Eczane Kamerası","Hastanede olması gereken {S2} adlı kişi, soygun gecesi bankanın karşısındaki eczane kamerasında görünüyor.",1,0],
       ["other","Hastane Kaydı","{S2} adlı kişi akşam hastaneye yatmış ama gece çıkış kaydı boş, bilekliği yatakta bulunmuş.",1,0],
       ["phone","Borç","{S2} adlı kişinin büyük kumar borcu olduğu mesajlardan anlaşılıyor.",1,0],
       ["phone","Pasaport","{S1} adlı kişi hafta sonu yurt dışında, giriş çıkış kaydı var.",1,0],
       ["witness","Tanık {W1}","{W1}, baş kasiyerin hafta sonu memleketteki düğünde olduğunu doğruluyor.",1,0],
       ["forensic","Maske","Kasada bir maske bulundu ama üzerinde kullanışlı bir iz yok.",0,1]] },

  { t:"Sahnedeki Suikast", e:"Suikast", d:"hard", st:"Sahnede vurulan konuşmacı; kalabalıktaki şüpheli sahte olabilir.", nS:8, nW:2, c:1,
    sum:"Kalabalık bir etkinlikte konuşmacı sahnede vuruldu. Sahte görevli kartıyla içeri giren, kurbanla husumetli bir aktivist hemen baş şüpheli oldu. Fakat kurşunun geliş açısı bu senaryoyla çelişiyor.",
    sol:"Suikastçı {S2} adlı kişi. Kurşun yukarıdan aşağı bir açıyla gelmiş; bu açı ancak yüksek kamera platformundan mümkün, arka koridordan değil. {S2} adlı kişinin sabit kameradaydım dediği yayın aynı kareyi tekrarlayan donmuş bir kayıttı ve yan kamera onu atış anında platformdan inerken yakaladı; hesabına olaydan önce kaynağı belirsiz büyük bir ödeme girmiş. Şüphelenilen {S7} adlı kişinin elindeki barut artığı ise patlattığı ses bombasından, sahte kartını ise çalındı diye önceden bildirmiş.",
    S:[["Etkinlik organizatörü","Sahne önünde, herkesin gözü önündeydi."],["Kameraman","Yüksek kamera platformunda tek başınaydı; sabit kameradaydım diyor."],["Güvenlik amiri","Atış anında ana kapıda telsizdeydi, kaydı var."],["Konuk gazeteci","Ön sırada oturuyordu; el testi temiz."],["Ses teknisyeni","Ses masasında, iki tanık doğruluyor."],["Garson","İkram alanında, koridora hiç girmedi."],["Husumetli aktivist","Sahte görevli kartıyla içerideydi, elinde barut artığı var, kurbanla husumetli."],["Sahne görevlisi","Işık panosundaydı, tanığı var."]],
    E:[["forensic","Atış Açısı","Kurşun yukarıdan aşağı bir açıyla gelmiş; bu açı ancak yüksek kamera platformundan mümkün, arka koridordan değil.",1,0],
       ["camera","Yan Kamera","Yan kamera, atış anında {S2} adlı kişiyi platformdan inerken yakaladı.",1,0],
       ["other","Donmuş Kayıt","{S2} adlı kişinin sabit kameradaydım dediği yayın, aynı kareyi tekrarlayan donmuş bir kayıttı.",1,0],
       ["phone","Ödeme","{S2} adlı kişinin hesabına etkinlikten önce kaynağı belirsiz büyük bir ödeme girmiş.",1,0],
       ["forensic","Aktivist Barutu","{S7} adlı kişinin elinde barut artığı var, ama bu artık patlattığı ses bombasından; kurşun barutuyla eşleşmiyor.",0,1],
       ["phone","Husumet","{S7} adlı kişinin kurbanla husumeti mesajlardan belli.",0,1],
       ["phone","Çalıntı Kart","Sahte kartın {S7} adına basıldığı sanıldı, ama {S7} adlı kişi kartının çalındığını olaydan önce bildirmiş.",0,1],
       ["camera","Sahne Önü","{S1} adlı kişi atış anında sahne önünde kameraya yakalanıyor.",1,0],
       ["phone","Telsiz","{S3} adlı kişi atış anında ana kapıdan telsiz konuşması yapıyor.",1,0],
       ["forensic","El Testi","{S4} adlı kişinin el testi tertemiz çıktı.",1,0],
       ["witness","Tanık {W1}","{W1}, yüksek platformda atış anında yalnız bir kişinin olduğunu söylüyor.",1,0],
       ["forensic","Kovan","Koridorda bir kovan bulundu ama tekmeyle oraya savrulmuş olabilir; marka çok yaygın.",0,1]] },

  { t:"Gümrüğün Gölgesi", e:"Organize Kaçakçılık", d:"hard", st:"Yasak mallar geçiyor; suç astın üstüne yıkılmış olabilir.", nS:8, nW:2, c:0,
    sum:"Bir gümrük noktasından aylardır yasak mal geçiyor; tarama kayıtları siliniyor. Silinen kayıtlar vardiya amirinin kullanıcısına çıkıyor ve hesabına nakit giriyor. Ama silmelerin yapıldığı an ve yer başka bir şeyi anlatıyor.",
    sol:"Asıl sorumlu {S1} adlı kişi. Silme işlemlerinden biri, {S4} adlı kişinin belgeli hastalık izninde olduğu güne denk ve o silmeler {S4} adlı kişinin masasından değil, şef odasındaki terminalin IP adresinden yapılmış. Şüpheli kamyonları taramadan geçiren elle onay belgelerinde {S1} adlı kişinin imzası var, vardiyaları o planlamış ve kendini hep o saatlerde listeden çıkarmış; kaçakçılık parası ona ait bir paravan şirkete akıyor.",
    S:[["Gümrük şefi","Vardiyaları o belirler, yetkisi geniş; ama şüpheli geçişlerin hiçbirinde vardiyada görünmüyor."],["Tarama operatörü","Cihazı kullanır ama log silme yetkisi yok."],["Bekçi","Bariyerde durur, sisteme erişemez."],["Vardiya amiri","Log silme yetkisi var, silinen kayıtlar kullanıcısına çıkıyor, hesabına nakit girmiş."],["Veteriner kontrol","Sadece canlı hayvana bakar."],["Evrak memuru","Belge girer ama taramaya erişemez."],["Forklift operatörü","Gece vardiyasına hiç kalmadı."],["Stajyer","Hiçbir sisteme yetkisi yok."]],
    E:[["phone","Log İzi","Silinen tarama kayıtları {S4} adlı kişinin kullanıcısına çıkıyor.",0,1],
       ["gps","Vardiya","Şüpheli kamyonların geçtiği vardiyalar {S4} adlı kişinin nöbetine denk geliyor.",0,1],
       ["phone","Nakit","{S4} adlı kişinin hesabına düzenli nakit giriyor.",0,1],
       ["other","İzin Kaydı","Silme işlemlerinden biri, {S4} adlı kişinin belgeli hastalık izninde olduğu güne denk; o gün işte değildi.",1,0],
       ["gps","Terminal Adresi","{S4} adlı kişinin hesabıyla yapılan silmeler, masasından değil şef odasındaki terminalin IP adresinden girilmiş.",1,0],
       ["other","Elle Onay","Şüpheli kamyonları taramadan geçiren elle onay belgelerinde {S1} adlı kişinin imzası var.",1,0],
       ["phone","Paravan Şirket","Kaçakçılık parası, sahibi {S1} adlı kişi olan bir paravan şirkete akıyor.",1,0],
       ["gps","Vardiya Planı","Şüpheli geçiş vardiyalarını {S1} adlı kişi planlamış ve kendini hep o saatlerde listeden çıkarmış.",1,0],
       ["gps","Operatör Yetkisi","{S2} adlı kişinin log silme yetkisi yok.",1,0],
       ["witness","Tanık {W1}","{W1}, şüpheli geçişlerde gece şef odasının ışığının yandığını söylüyor.",1,0],
       ["witness","Tanık {W2}","{W2}, vardiya amirinin aldığı nakitlerin aslında şefin verdiği bir pay olduğunu duymuş.",0,1],
       ["forensic","Sahte Mühür","Bir konteynerde sahte mühür bulundu ama çok sayıda kişi bu mühre erişebiliyor.",0,1]] },

  { t:"Ormandaki İz", e:"Kayıp Kişi", d:"hard", st:"Yürüyüşten dönmeyen kişi; borçlu ortak ilk şüpheli ama tek izah o değil.", nS:8, nW:2, c:4,
    sum:"Grup halinde doğa yürüyüşüne çıkan biri geri dönmedi. Kurbanla borç yüzünden tartışan iş ortağı hemen şüpheli görüldü. Fakat kurbanın telefonunun son sinyali bambaşka bir yöne işaret ediyor.",
    sol:"Sorumlu {S5} adlı kişi. Kurbanın telefonu en son yalnızca yan patikadan erişilen bir baz istasyonuna bağlanmış ve o yan patikanın varlığını grupta yalnızca {S5} adlı kişi biliyordu; botundaki çamur ve bitki örtüsü ana patikaya değil, yan patikadaki dere yatağına ait. Şüphelenilen {S1} adlı kişi ise olay boyunca ana patikadaki fotokapanda görünüyor; tartışması da bir tehdit değil, borç ödeme planıyla ilgiliymiş.",
    S:[["İş ortağı","Kurbanla borç yüzünden tartıştı, sigortadan kazancı var; son görüldüğünde kavga ediyorlardı."],["Tur rehberi","Tüm grubu ana patikada tuttu, fotoğraf zaman damgaları doğruluyor."],["Kurbanın eşi","Kamp alanından hiç ayrılmadı, onlarca tanık."],["Acemi kampçı","Yolu bilmez, sürekli grupla birlikteydi."],["Deneyimli patika dostu","Bölgeyi en iyi o bilir; kurbanı manzara var diye yan patikaya o götürdü."],["Park görevlisi","Kulübede telsiz başındaydı, kayıt var."],["Fotoğrafçı","Ana patikada sabit çekim yapıyordu, zaman damgaları sürekli."],["Sırt çantacı genç","Grubun önündeydi, herkes gördü."]],
    E:[["gps","Son Sinyal","Kurbanın telefonu en son yalnızca yan patikadan erişilen bir baz istasyonuna bağlanmış.",1,0],
       ["phone","Yan Patika Bilgisi","O yan patikanın varlığını grupta yalnızca {S5} adlı kişi biliyordu.",1,0],
       ["forensic","Çamur ve Bitki","{S5} adlı kişinin botundaki çamur ve bitki örtüsü, ana patikaya değil yan patikadaki dere yatağına ait.",1,0],
       ["camera","Fotokapan","Ana patikadaki fotokapan, {S1} adlı kişiyi olay boyunca ana yolda gösteriyor.",1,0],
       ["phone","Borç ve Sigorta","{S1} adlı kişinin kurbanla borcu ve onun üzerinden sigorta kazancı olduğu biliniyor.",0,1],
       ["witness","Tanık {W1}","{W1}, kurbanla {S1} adlı kişinin çıkıştan önce tartıştığını gördü.",0,1],
       ["other","Tartışma Kaydı","Tartışma bir ses kaydında var ama içeriği borç ödeme planıyla ilgili, tehdit değil.",0,1],
       ["gps","Rehber Konumu","{S2} adlı kişi tüm grupla ana patikada baz veriyor.",1,0],
       ["witness","Tanık {W2}","{W2}, kurbanın bir noktada {S5} adlı kişiyle ana yoldan ayrıldığını hatırlıyor.",1,0],
       ["camera","Kamp Kamerası","{S3} adlı kişi kamp alanı kamerasında sürekli görünüyor.",1,0],
       ["forensic","Kesik İp","Yan patikada kesik bir ip parçası bulundu; düğüm tarzı dağcılık bilen birine işaret ediyor.",1,0],
       ["forensic","Ayak İzi","Yan patikada birden çok ayak izi var ama zemin taşlık olduğu için ölçü net değil.",0,1]] },

  { t:"Sızan Tasarım", e:"Kurumsal Casusluk", d:"hard", st:"Gizli tasarım sızdı; kırgın tasarımcı ilk akla gelen ama tek aday değil.", nS:8, nW:2, c:5,
    sum:"Gizli bir ürün tasarımı rakibe sızdı. Terfi alamayan, rakiple yazışması çıkan kıdemli tasarımcı baş şüpheli oldu. Fakat sızan dosyanın izleri beklenmedik bir yeri gösteriyor.",
    sol:"Sorumlu {S6} adlı kişi. Rakibe sızan dosyada görünmez bir baskı filigranı var ve bu filigran {S6} adlı kişinin çıktı işine ait; yüksek çözünürlüklü dışa aktarım onun baskı sunucusundan yapılmış ve sızan dosya yalnızca baskı arşivinde bulunan eski bir sürüm. Şüphelenilen {S1} adlı kişinin rakiple yazışması ise bir iş görüşmesiydi; dosyaya yalnızca ofis içinde baktı, dışa aktarmadı.",
    S:[["Kıdemli tasarımcı","Tasarıma erişimi vardı, terfi alamadı, rakip firmayla yazışması çıktı."],["Proje müdürü","Dosyaya erişir ama sızma haftası yurt dışı fuardaydı."],["Pazarlama uzmanı","Yalnızca görselleri görür, kaynak dosyaya erişemez."],["Stajyer tasarımcı","Yalnızca izleme yetkisi, dışa aktaramaz."],["Hukuk danışmanı","Sözleşmeleri görür, tasarım dosyasına erişimi yok."],["Baskı ve sistem sorumlusu","Tüm dosyalar çıktı için onun sunucusundan geçer; kimse ondan şüphelenmez."],["Satış temsilcisi","Müşteriyle görüşür, iç sisteme giremez."],["Ofis asistanı","Toplantı ayarlar, dosya yetkisi yok."]],
    E:[["forensic","Baskı Filigranı","Rakibe sızan dosyada görünmez bir baskı filigranı var; bu filigran {S6} adlı kişinin çıktı işine ait.",1,0],
       ["phone","Sunucu Logu","Tasarımın yüksek çözünürlüklü dışa aktarımı {S6} adlı kişinin baskı sunucusundan yapılmış.",1,0],
       ["phone","Ödeme","{S6} adlı kişinin hesabına rakip firmayla bağlantılı bir hesaptan ödeme girmiş.",1,0],
       ["phone","Rakip Yazışma","{S1} adlı kişinin rakiple yazıştığı doğru, ama bu bir iş görüşmesiydi; ekinde dosya yok.",0,1],
       ["phone","Terfi","{S1} adlı kişinin terfi alamadığı için kırgın olduğu biliniyor.",0,1],
       ["gps","Erişim Kaydı","{S1} adlı kişi dosyaya erişti ama yalnızca ofis içinde görüntüledi, dışa aktarım yapmadı.",1,0],
       ["phone","Fuar","{S2} adlı kişi sızma haftası yurt dışı fuarda, kaydı var.",1,0],
       ["gps","Pazarlama Yetkisi","{S3} adlı kişi yalnızca görselleri görür, kaynak dosyaya erişemez.",1,0],
       ["witness","Tanık {W1}","{W1}, geç saatte baskı odasında yalnız çalışan {S6} adlı kişiyi görmüş.",1,0],
       ["witness","Tanık {W2}","{W2}, kıdemli tasarımcının o akşam erkenden çıktığını doğruluyor.",1,0],
       ["other","Sahipsiz USB","Ofiste sahipsiz bir USB bulundu ama içi boş, kime ait belirsiz.",0,1],
       ["phone","Dosya Sürümü","Sızan dosya eski bir sürüm; bu sürüme yalnızca baskı arşivinden ulaşılabilirdi.",1,0]] },

  { t:"Fidye Notu", e:"Kaçırma ve Fidye", d:"hard", st:"Çocuk kaçırıldı; kinli eski çalışan ilk şüpheli ama iş içeriden olabilir.", nS:8, nW:2, c:2,
    sum:"Bir iş insanının çocuğu kaçırıldı, fidye istendi. Aileye kin besleyen, tehdit mesajları atmış eski muhasebeci baş şüpheli oldu. Fakat fidye notundaki bir ayrıntı işin içeriden olduğunu söylüyor.",
    sol:"Sorumlu {S3} adlı kişi. Fidye notunda çocuğun yalnızca evdekilerin bildiği bir lakabı kullanılmış; {S3} adlı kişinin aracı çocuğu okuldan alıp eve değil ıssız bir depoya gitmiş, fidye hattı ise onun bir yakınının adına kayıtlı ve büyük bir borcu var. Şüphelenilen {S4} adlı kişinin tehdit mesajları aylar öncesine ait ve kaçırma saatinde şehrin öbür ucunda baz veriyor.",
    S:[["İş ortağı","Şirket parasına erişir ama kaçırma günü yurt dışında."],["Çocuğun öğretmeni","Okulda onlarca tanık."],["Aile şoförü","Çocuğun günlük rutinini ve ev içini en iyi o bilir; çocuk ona güvenir."],["Eski muhasebeci","Aileye kin besliyor, tehdit mesajları atmıştı."],["Bahçıvan","Olay saatinde başka evde çalışıyordu, işveren doğruluyor."],["Komşu","Aileyle yalnızca yüzeysel tanışıklığı var."],["Dadı","Çocukla ilgilenir ama kaçırma günü izinliydi, konumu uzakta."],["Aile avukatı","Mali işleri bilir ama o gün duruşmadaydı, kaydı var."]],
    E:[["other","Not Detayı","Fidye notunda çocuğun yalnızca evdekilerin bildiği bir lakabı kullanılmış.",1,0],
       ["gps","Araç Rotası","{S3} adlı kişinin aracı, çocuğu okuldan alıp eve gitmek yerine ıssız bir depoya gitmiş.",1,0],
       ["phone","Fidye Hattı","Fidye için verilen telefon hattı {S3} adlı kişinin bir yakınının adına kayıtlı.",1,0],
       ["phone","Borç","{S3} adlı kişinin ödenmemiş büyük bir borcu olduğu anlaşıldı.",1,0],
       ["phone","Tehdit","{S4} adlı kişinin aileye tehdit mesajları attığı doğru, ama mesajlar aylar öncesine ait.",0,1],
       ["gps","Muhasebeci Konumu","{S4} adlı kişi kaçırma saatinde şehrin öbür ucunda baz veriyor.",1,0],
       ["phone","Yurt Dışı","{S1} adlı kişi kaçırma günü yurt dışında, kaydı var.",1,0],
       ["gps","Dadı İzni","{S7} adlı kişi kaçırma günü izinli, konumu uzakta.",1,0],
       ["witness","Tanık {W1}","{W1}, çocuğun isteyerek tanıdığı birinin arabasına bindiğini, hiç zorlanmadığını görmüş.",1,0],
       ["witness","Tanık {W2}","{W2}, eski muhasebecinin son aylarda şehirde bile olmadığını söylüyor.",0,1],
       ["forensic","Kağıt","Fidye notu sıradan bir kağıda yazılmış; markası ayırt edici değil.",0,1],
       ["other","Yazı Tarzı","Not bilgisayarla yazılmış; üslup eğitimli birine işaret ediyor ama bu çok kişiye uyar.",0,1]] },

  { t:"Müzedeki Boş Çerçeve", e:"Sanat Eseri Hırsızlığı", d:"hard", st:"Tablo gece alındı sanıldı; aslında çoktan değiştirilmiş olabilir.", nS:8, nW:2, c:2,
    sum:"Bir müzeden değerli bir tablo gece çalındı sanılıyor; alarm kapatılmış, kamera döngüye alınmış. Tüm oklar güvenlik teknisyenini gösteriyor. Fakat çerçevede kalan tuval başka bir hikâye anlatıyor.",
    sol:"Hırsız {S3} adlı kişi. Çerçevede kalan tablo aslında yakın tarihli bir sahte; boyası tam kürlenmemiş, pigmentleri modern ve bu malzemeler {S3} adlı kişinin atölyesinde var. Orijinal, haftalardır temizlik bahanesiyle gözetimsiz onun elindeydi ve bir koleksiyoncuyla gizli satış yazışması bulundu. Gece kamerayı döngüye alan komut {S1} adlı kişinin terminalinden girilmiş görünse de o komut ortak bakım hesabıyla önceden zamanlanmıştı; o anda {S1} adlı kişi evindeydi.",
    S:[["Güvenlik teknisyeni","Kamera ve alarmı yönetir; gece terminalden komut girilmiş, aracında ambalaj bulundu."],["Müze müdürü","Şifreleri bilir ama o gece bir galada, kamerada görünüyor."],["Restoratör","Tabloyu temizlik için haftalarca gözetimsiz yalnız o elinde tuttu."],["Bekçi","Yalnızca turla dolaşır, sisteme erişemez."],["Rehber","Gündüz çalışır, gece yetkisi yok."],["Temizlikçi","Salonlara girer ama teknik sisteme erişemez."],["Küratör","Eserleri bilir ama o gece şehir dışındaydı."],["Sigorta eksperi","Yalnızca rapor için gelmişti, depoya girmedi."]],
    E:[["forensic","Sahte Tuval","Çerçevede kalan tablo yakın tarihli bir sahte; boyası henüz tam kürlenmemiş.",1,0],
       ["other","Restorasyon Kaydı","Orijinal tablo haftalardır temizlik için {S3} adlı kişide gözetimsiz bekliyordu.",1,0],
       ["forensic","Pigment","Sahte tablonun pigmentleri modern; bu malzemelere erişim {S3} adlı kişinin atölyesinde var.",1,0],
       ["phone","Gizli Alıcı","{S3} adlı kişinin bir koleksiyoncuyla gizli satış yazışması bulundu.",1,0],
       ["phone","Gece Komutu","Gece kamerayı döngüye alan komut {S1} adlı kişinin terminalinden girilmiş görünüyor.",0,1],
       ["other","Zamanlanmış Görev","O komut aslında ortak bakım hesabıyla önceden zamanlanmış; o anda {S1} adlı kişi evindeydi.",1,0],
       ["forensic","Ambalaj","{S1} adlı kişinin aracındaki ambalaj, müze deposundan herkesin aldığı standart malzeme.",0,1],
       ["camera","Gala","{S2} adlı kişi o gece bir galada kameraya yakalanıyor.",1,0],
       ["gps","Şehir Dışı","{S7} adlı kişi o gece şehir dışında, konum kaydı var.",1,0],
       ["witness","Tanık {W1}","{W1}, son haftalarda tabloyu yalnızca restoratörün taşıdığını söylüyor.",1,0],
       ["witness","Tanık {W2}","{W2}, gece teknik odanın boş olduğunu, kimsenin girmediğini söylüyor.",1,0],
       ["forensic","Eldiven İzi","Çerçevede eldiven izi var ama tüm personel aynı eldiveni kullandığı için ayırt edici değil.",0,1]] },

  { t:"Hayalet Hesaplar", e:"Siber Dolandırıcılık Ağı", d:"hard", st:"Sahte hesaplar açıldı; kıdemli geliştirici suçlu görünüyor ama tuzağa düşmüş olabilir.", nS:8, nW:2, c:1,
    sum:"Bir şirketin altyapısıyla sahte hesaplar açılıp büyük dolandırıcılık yapıldı. Oturum, kıdemli geliştiricinin ev adresine ve VPN bağlantısına çıkıyor. Fakat o sırada onun bambaşka bir yerde olduğu ortaya çıkıyor.",
    sol:"Sorumlu {S2} adlı kişi. Ana loglar temiz görünse de bir yedek replikasyon sunucusu, sahte hesapları açan oturumun {S2} adlı kişiye ait olduğunu saklamış; o gece log temizleme komutları çalıştırmış ve sahte hesaplar yalnızca veritabanı yöneticisinin kullandığı bir iç komut setiyle açılmış. Şüphelenilen {S7} adlı kişinin VPN bağlantısı ev adresinden açılırken kendisi uluslararası bir uçaktaydı; biniş kartı ve uçak wifi kaydı var, yani kimlik bilgileri çalınmış.",
    S:[["Yazılım takım lideri","Olay haftası ücretli izindeydi, sisteme hiç bağlanmadı."],["Veritabanı yöneticisi","Sunucuya tam erişir ve kendi loglarını temizleyebilir."],["Ağ uzmanı","Yalnızca ağ donanımına bakar, hesap sistemine giremez."],["Destek görevlisi","Yalnızca kullanıcı şifresi sıfırlar, hesap açamaz."],["Tester","Test ortamına erişir, canlı sisteme değil."],["Sistem mimarı","Olay saatlerinde konferansta, kamerada."],["Kıdemli geliştirici","Sahte hesap oturumu ev adresine ve VPN bağlantısına çıkıyor, kripto cüzdanı bağlantılı görünüyor."],["Stajyer","Yalnızca okuma yetkisi var, yazma yetkisi yok."]],
    E:[["phone","Yedek Sunucu","Ana loglar temiz ama bir yedek sunucu, sahte hesapları açan oturumun {S2} adlı kişiye ait olduğunu saklamış.",1,0],
       ["phone","Log Temizliği","{S2} adlı kişi olay gecesi log temizleme komutları çalıştırmış.",1,0],
       ["phone","İç Komut Seti","Sahte hesaplar yalnızca veritabanı yöneticisinin kullandığı bir iç komut setiyle açılmış; bu da {S2} adlı kişiye işaret ediyor.",1,0],
       ["gps","Uçuş Kaydı","{S7} adlı kişinin VPN bağlantısı ev adresinden açılırken, kendisi uluslararası bir uçaktaydı; biniş kartı ve uçak wifi kaydı var.",1,0],
       ["other","Çalıntı Kimlik","{S7} adlı kişinin VPN bilgileri masasındaki bir nottan sızmış olabilir; oturum onun adına ama o sırada erişimi imkânsızdı.",1,0],
       ["phone","Kripto Cüzdan","{S7} adlı kişinin cüzdanı bağlantılı görünüyor ama paraya, o uçaktayken aktarım yapılmış.",0,1],
       ["phone","İzin","{S1} adlı kişi olay haftası izinde, sisteme hiç bağlanmamış.",1,0],
       ["gps","Ağ Yetkisi","{S3} adlı kişi hesap sistemine giremez, yalnızca ağ donanımına bakar.",1,0],
       ["camera","Konferans","{S6} adlı kişi olay saatlerinde bir konferansta, kamerada görünüyor.",1,0],
       ["witness","Tanık {W1}","{W1}, gece ofiste kalan tek kişinin veritabanı yöneticisi olduğunu söylüyor.",1,0],
       ["witness","Tanık {W2}","{W2}, kıdemli geliştiricinin o hafta yurt dışı uçuşu olduğunu doğruluyor.",0,1],
       ["forensic","Ortak Dizüstü","Ortak bir dizüstüde izler var ama herkes kullandığı için ayırt edici değil.",0,1]] },

  { t:"Köprü Altındaki İnfaz", e:"Mafya İnfazı", d:"hard", st:"Tetikçi infaz edildi; kan davalı kişi suçlu sanılıyor ama tuzak olabilir.", nS:8, nW:2, c:0,
    sum:"Bir suç örgütünün adamı köprü altında infaz edildi. Kurbanla kan davası olan tetikçi; balistik, barut artığı ve konumla baş şüpheli oldu. Fakat tüm bu deliller fazla derli toplu.",
    sol:"Tetikçi {S1} adlı kişi. Kurban, {S1} adlı kişinin hesaplardan para çaldığını patrona açıklamakla tehdit ediyordu; kumarhanedeydim dediği görüntü aynı kareyi tekrarlayan oynanmış bir kayıt ve infazdan sonra kontrolündeki bir hesaptan kayıt dışı büyük ödeme çıkmış. Şüphelenilen {S4} adlı kişiye bağlanan silah aylar önce ondan çalınmıştı, elindeki barut artığı o gün gittiği atış poligonundan ve olay yerine {S1} adlı kişinin hattından gelen sahte bir buluşma mesajıyla çekilmiş.",
    S:[["Örgüt muhasebecisi","Para işlerini bilir; kurban onun zimmetini patrona açıklamakla tehdit ediyordu."],["Şoför","O gece başka şehirde teslimattaydı."],["Koruma","Olay saatinde patronun yanındaydı."],["Husumetli tetikçi","Kurbanla kan davası var; balistik ona bağlı silaha çıkıyor, elinde barut artığı, olay yerine yakın görünüyor."],["Bar işletmecisi","Barı açıktı, kamerada görünüyor."],["Haberci","Mesaj taşır, silah kullanmaz, olay saatinde uzaktaydı."],["Eski ortak","O gece hastanede yatıyordu."],["Tefeci","Olay saatinde başka semtte tanıkla birlikteydi."]],
    E:[["phone","Zimmet ve Tehdit","Kurban, {S1} adlı kişinin hesaplardan para çaldığını patrona açıklamakla tehdit ediyordu.",1,0],
       ["camera","Kumarhane Kaydı","{S1} adlı kişinin kumarhanedeydim dediği görüntü, aynı kareyi tekrarlayan oynanmış bir kayıt.",1,0],
       ["other","Ödeme İzi","İnfazdan sonra {S1} adlı kişinin kontrolündeki bir hesaptan kayıt dışı büyük ödeme çıkmış.",1,0],
       ["phone","Sahte Buluşma","{S4} adlı kişiyi olay yerine, {S1} adlı kişinin hattından gönderilen sahte bir buluşma mesajı çekmiş.",1,0],
       ["forensic","Çalıntı Silah","Balistik {S4} adlı kişiye bağlı eski silaha çıkıyor, ama o silah aylar önce ondan çalınmış olarak kayıtlı.",0,1],
       ["forensic","Poligon Barutu","{S4} adlı kişinin elindeki barut artığı o gün gittiği atış poligonundan; poligon kaydı var.",0,1],
       ["gps","Tetikçi Konumu","{S4} adlı kişi olay yerine yakın görünüyor ama oraya sahte mesajla çağrıldığı için.",0,1],
       ["gps","Teslimat","{S2} adlı kişi o gece başka şehirde teslimatta, konum kaydı var.",1,0],
       ["witness","Koruma","{S3} adlı kişi olay saatinde patronun yanında, iki kişi şahit.",1,0],
       ["phone","Hastane","{S7} adlı kişi o gece hastanede yatıyordu.",1,0],
       ["witness","Tanık {W1}","{W1}, infazdan önce köprü altına gelen arabanın muhasebecininkine benzediğini söylüyor.",1,0],
       ["witness","Tanık {W2}","{W2}, tetikçinin gün boyu atış poligonunda olduğunu doğruluyor.",0,1]] }
];
...
async function seedDetectiveChars() {
  ...
  if (ver === 'chars31h') return;
  var r = await _runDetectiveSeed();
  if (r.ok) { await setConfig('detective_seed_v', 'chars31h'); console.log('Dedektif: ' + r.count + ' vaka seed edildi (havuz: ' + r.poolSize + ' karakter).'); }
...
async function regenerateDetectiveCases() {
  var r = await _runDetectiveSeed();
  if (r.ok) await setConfig('detective_seed_v', 'chars31h');
  return r;
}

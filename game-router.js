      ...
      '<div style="display:flex;justify-content:space-between;align-items:center;height:80px;padding:0 32px;max-width:100%">' +
        ...
        '<div style="display:flex;align-items:center;gap:12px">' +
          ...
          (typeof curUser!=='undefined'&&curUser?
            '<div style="display:flex;align-items:center;gap:10px;padding:8px 16px;border-radius:12px;background:#1f1f28"><div style="width:36px;height:36px;border-radius:10px;background:rgba(255,84,77,0.12);display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:700;color:#ffb4ac">'+esc(curUser.username)[0].toUpperCase()+'</div><span style="font-size:14px;font-weight:600;color:#e4e1ee">'+esc(curUser.username)+'</span><button class="btn bg bsm" style="color:#ffb4ac;border:1px solid rgba(255,84,77,0.2)" onclick="doLogout()">Çıkış</button></div>'
          :

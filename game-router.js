...
let GN={DIE:'Kim Hayatta Kalacak',TEAM:'Ekibini Kur',FATE:'Kaderini Seç',FACE:'Yüzden Bil',QUOTE:'Replik Bil',MEM:'Eightborn Moruq',WHO:'Sen Kimsin?',STREAM:'Yayıncı Oyunları',RANK:'Karakter Sırala',STOCK:'Karakter Borsası',RPSIM:'RP Simülasyonu'};
function gcH(){
...
function play(t){
  ...
  if(t==='DIE')dieStart();else if(t==='TEAM')teamStart();else if(t==='FATE')fateStart();else if(t==='FACE')faceStart();else if(t==='QUOTE')quoteStart();else if(t==='MEM')memStart();else if(t==='WHO')whoStart();else if(t==='STREAM')streamStart();else if(t==='RANK')rankStart();else if(t==='STOCK')stockStart();else if(t==='RPSIM')rpsimStart();else genericGame(t);
}
function bk(){
  ...
  tState=null;dState=null;tmState=null;ftState=null;fcState=null;rqState=null;mState=null;whState=null;rkState=null;skState=null;rpsimState=null;

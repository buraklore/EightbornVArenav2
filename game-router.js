...
let GN={DIE:'Kim Hayatta Kalacak',TEAM:'Ekibini Kur',FATE:'Kaderini Seç',FACE:'Yüzden Bil',QUOTE:'Replik Bil',MEM:'Eightborn Moruq',WHO:'Sen Kimsin?',STREAM:'Yayıncı Oyunları',RANK:'Karakter Sırala',STOCK:'Karakter Borsası',RPSIM:'RP Simülasyonu',DETECTIVE:'Dedektif Dosyası',STORYGEN:'Karakter Hikayesi'};
function gcH(){
...
function play(t){
  ...
  if(t==='DIE')dieStart();else if(t==='TEAM')teamStart();else if(t==='FATE')fateStart();else if(t==='FACE')faceStart();else if(t==='QUOTE')quoteStart();else if(t==='MEM')memStart();else if(t==='WHO')whoStart();else if(t==='STREAM')streamStart();else if(t==='RANK')rankStart();else if(t==='STOCK')stockStart();else if(t==='RPSIM')rpsimStart();else if(t==='DETECTIVE')detStart();else if(t==='STORYGEN')storygenSoloStart();else genericGame(t);
}
function bk(){
  ...
  tState=null;dState=null;tmState=null;ftState=null;fcState=null;rqState=null;mState=null;whState=null;rkState=null;skState=null;rpsimState=null;detState=null;
...
window.addEventListener('load', function() {
  ...
  window._buildGameCards = function() {
    ...
    var games = [
      ...
      {e:'\ud83c\udfae',t:'RPSIM',n:'RP Simülasyonu',d:'Şehrin kralı mı olacaksın soytarısı mı?',diff:'YENİ!',dc:'rgba(167,139,250,.1);color:#a78bfa',ib:'linear-gradient(135deg,#292933,#1f1f28)'},
      {e:'\ud83d\udd75\ufe0f',t:'DETECTIVE',n:'Dedektif Dosyası',d:'Kanıtları incele, şüphelileri sorgula, suçluyu bul',diff:'YENİ!',dc:'rgba(202,164,106,.12);color:#caa46a',ib:'linear-gradient(135deg,#292933,#1f1f28)'},
      {e:'\ud83d\udcd6',t:'STORYGEN',n:'Karakter Hikayesi',d:'10 soruyu cevapla, sana özel bir RP karakter hikâyesi üret',diff:'YENİ!',dc:'rgba(167,139,250,.12);color:#c4b5fd',ib:'linear-gradient(135deg,#292933,#1f1f28)'}
    ];
    // Apply custom names
